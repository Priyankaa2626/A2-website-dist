...
`)}function _M(t){const e=st.getPrimaries(st.workingColorSpace),n=st.getPrimaries(t);let i;switch(e===n?i="":e===Wo&&n===Vo?i="LinearDisplayP3ToLinearSRGB":e===Vo&&n===Wo&&(i="LinearSRGBToLinearDisplayP3"),t){case ii:case ua:return[i,"LinearTransferOETF"];case Dt:case Cc:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",t),[i,"LinearTransferOETF"]}}function Qf(t,e,n){const i=t.getShaderParameter(e,t.COMPILE_STATUS),r=t.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return n.toUpperCase()+`
